...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'app.type.entity_hidden' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\Type\EntityHiddenType A AppBundle\Form\Type\EntityHiddenType instance.
     */
    protected function getApp_Type_EntityHiddenService()
    {
        return $this->services['app.type.entity_hidden'] = new \AppBundle\Form\Type\EntityHiddenType($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57226861226042.89659190')), true);
