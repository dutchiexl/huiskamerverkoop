...
window.Feedback = function( options ) {
    ...
    options.nextLabel = options.nextLabel || "Verder";
    options.reviewLabel = options.reviewLabel || "Review";
    options.sendLabel = options.sendLabel || "Verstuur";
    options.closeLabel = options.closeLabel || "Sluit";

    options.messageSuccess = options.messageSuccess || "Je feedback werd verstuurd.";
    ...
    options.blackoutHighlightText = options.blackoutHighlightText || "Kan je aangeven waar het probleem zich voordoet ?";
...
window.Feedback.Form = function( elements ) {
    ...
    this.elements = elements || [{
        type: "textarea",
        name: "Probleem",
        label: "Kan je je probleem omschrijven aub?",
        required: false
    }];
